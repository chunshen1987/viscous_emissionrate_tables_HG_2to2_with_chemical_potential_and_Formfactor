...
inline double viscous_integrand(double s, double t, double E1, double E2, double Eq, double* m, double f0_E1, double f0_E2, double f0_E3)
{
   ...
   double integrand = (1. + f0_E1)*deltaf_chi(p1)*0.5*(-1. + 3.*costheta1*costheta1) + (1. + f0_E2)*deltaf_chi(p2)*0.5*(-1. + 3.*costheta2*costheta2) + f0_E3*deltaf_chi(p3)/p3/p3*(-0.5*p3*p3 + 1.5*p3_z*p3_z);
